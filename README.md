...
Giang_Sinh_An_Lanh is a user-friendly application designed to enhance your holiday celebrations. With simple features, you can plan and enjoy your festive moments without any stress. 

## 🚀 Getting Started

Follow these steps to download and run Giang_Sinh_An_Lanh on your computer.
...
After installation, you can launch the app from your programs menu.

### 🔍 Features

- **Event Planner**: Organize your holiday events effectively.
- **Reminders**: Set reminders for important tasks leading to the festivities.
- **Budget Tracker**: Keep track of your expenses to enjoy your celebrations without overspending.
- **Guest Management**: Easily manage guest lists and RSVPs.

## 🖼️ User Interface

The Giang_Sinh_An_Lanh interface is designed with simplicity in mind. You will find:

- A clear main menu with easy navigation options.
- Intuitive buttons for quick access to features.
- A vibrant design that captures the festive spirit. 
